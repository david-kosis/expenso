...
function Reports() {
  ...
  const supplierRows = useMemo(() => {
    ...
    suppliers.forEach((supplier) => {
      supplier.purchases?.forEach(
        (purchase) => {
          if (
            !dateAllowed(purchase.date)
          ) {
            return;
          }
        ...
        <main className="page-container">
          ...
          <section className="report-summary-grid">
            ...
            <div className="report-summary-card">
              ...
              <small>
                {customerRows.length} transactions
              </small>
          ...
          <ReportTable
            ...
            subtitle="Sales, payments and outstanding balances."
            rows={customerRows}
            type="customers"
          />
          ...
          <ReportTable
            ...
            subtitle="Purchases and payments made to suppliers."
            rows={supplierRows}
            type="suppliers"
          />
